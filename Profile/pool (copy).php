...
<?php	
	...
	$result = mysql_query("SELECT * FROM tours where userName='".$_SESSION['user']."'");
						...
						<center><table width=70%>
							...
							<tr><td>&nbsp;</td></tr>	
						  	<tr>
								<td>Preferences</td>
								<td>".$pref."</td>
						  	</tr>".$prefm."<tr><td>&nbsp;</td></tr>
						</table><a id='fs".$count."' href='findshare.php?id=".$row['id']."'>Find Route Sharers =></a></center>						
					</div>";	
					$count=$count+1;
					$temp='';
					$st="display:none;";
